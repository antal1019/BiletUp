...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($nume) || $pret <= 0 || $cantitate_totala <= 0) {
        ...
        if(isset($_POST['ticket_type_id']) && !empty($_POST['ticket_type_id'])) {
            ...
            $update_stmt->bind_param("ssdiisii", $nume, $descriere, $pret, $cantitate_totala, 
                                    $cantitate_disponibila, $status, $ticket_type_id, $event_id);
            ...
            $insert_stmt->bind_param("issdiis", $event_id, $nume, $descriere, $pret, 
                                    $cantitate_totala, $cantitate_disponibila, $status);
